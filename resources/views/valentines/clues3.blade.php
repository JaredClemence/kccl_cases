...
Song: <em>Waiting For You</em> by Grizfolk<br/>
<audio controls autoplay preload='auto'>
    <source src='{{asset('music/wait_for_you.mp3')}}' type='audio/mpeg' autoplay="autoplay"></source>
</audio>
        </div></div>
    ...
    <div class='row'>
        <div class='col-8 offset-2'>
            <h2>Activity 3</h2>
            <p>Call your husband. I've made it easy for you, just press this button and it will dial your phone for you.</p>
            <a class='btn btn-primary btn-block' href='tel:+16103609558'>Call Husband</a>
        </div>
    </div>
